<template>
 ...
 <p style="text-align: left; margin-top: 60px; margin-bottom: 60px;">
        ...
        <img src="@/assets/arr.svg" alt="ZuniLife" style="width: 20px; margin-left: 5px;"><a style=" margin-left: 5px;" v-bind:class="{ clWhite: dark == false,  clDark: dark == true }">{{ $t('LanguageEn.about') }} </a>
    </p>     
...
this.cookiesObject = cookiesObject;
        ...
        fetch(window.API+"/pageInfo?languageId=" + 2 + "&pageId=" + 1, requestOptions)
