  ...
  <div class="section">
    <div v-if="cookiesObject.permission == 'granted'" style="" class="container">
      <div v-bind:class="{ row: windowHeight > 765 }" class="">
        <div class="row" v-bind:class="{ clWhite1: dark == false, clDark1: dark == true }" style="border-radius: 9px">
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12" v-for="(post, j) in rel1" :key="j">
            <div class="col">
              <div class="blog_post">
                <div class="blog_img">
                  <router-link :to="{
                    name: 'categoryPosts',
                    params: { categoryId: post.id, servicId: post.serviceId },
                  }">
                    <img class="mainImg" :src="imageLink + post.icon" :alt="post.icon"
                      style="height: 110px; width: 100%; border-radius: 9px" />
                  </router-link>
                </div>
                    ...
                    <h5 class="">
                      <router-link :to="{
                        ...
                        <span style="
                            ...
                            padding: 3px 7px;
                            border-radius: 4px;
                          " v-html="post.name" v-bind:class="{
                            redPill: post.id == 1,
                            orangePill: post.id == 2,
                            bluePill: post.id == 3,
                            yellowPill: post.id == 4,
                            pinkPill: post.id == 5,
                            maroonPill: post.id == 6,
                          }">
                        </span>
                      </router-link>
                    </h5>
    ...
    <div v-else style="" class="container">
      <div v-bind:class="{ row: windowHeight > 765 }" class="">
        <div class="row" v-bind:class="{ clWhite1: dark == false, clDark1: dark == true }"
          style="border-radius: 9px; padding: 20px">
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12" v-for="(post, j) in rel1" :key="j">
            <div class="col">
              <div class="blog_post">
                <div class="blog_img">
                  <img class="mainImg" v-b-modal="modOpen" :src="imageLink + post.icon" :alt="post.icon"
                    style="height: 130px; width: 100%; border-radius: 9px" />
                </div>
                <div class="blog_content">
                  <div class="blog_text">
                    <h5 class="">
                      <span v-b-modal="modOpen" style="
                          font-size: 12px;
                          color: white;
                          font-weight: 650;
                          padding: 3px 7px;
              ...
              <div class="blog_img">
                <a>
                  <router-link :to="{
                    ...
                    params: {
                      ...
                      servicId: article.category.serviceId,
                      contentId: article.id,
                    },
                  }">
                    <!-- <div class="newBadge" v-if="post.alreadySeen">Nouvel</div> -->

                    <img :src="imageLink + article.thumbnail" :alt="article.thumbnail" style="
                        width: 90%;
                        object-fit: cover;
                        height: 200px;
                        border-radius: 9px;
                ...
                <div class="blog_tags">
                  <a class="blog_tags_cat bg_warning" v-bind:class="{
                    redPill: article.category.id == 1,
                    orangePill: article.category.id == 2,
                    bluePill: article.category.id == 3,
                    yellowPill: article.category.id == 4,
                    pinkPill: article.category.id == 5,
                    maroonPill: article.category.id == 6,
              ...
              <div class="blog_content">
                <router-link :to="{
                  ...
                  <div class="" v-bind:class="{
                    ...
                    <h6 class="" style="">
                      <span class="listItem" v-html="article.contentDataSet[0].title"></span>
                    </h6>
                    <p style="color: #686868" v-html="article.contentDataSet[0].body"></p>
                  </div>
                </router-link>
              </div>
            </div>
        ...
        <div class="row">
          <div v-for="article in bundle.initialContent" :key="article.id" class="col-xl-3 col-lg-3 col-md-6 pl-2 pr-2"
            ...
            <div class="blog_post">
              ...
              <div class="blog_content">
                <div class="blog_text" v-bind:class="{
                  clWhite: dark == false,
                  clDark: dark == true,
                }">
...
export default {
  ...
  async created() {
    ...
    if (cookiesObject.permission == "granted") {
      this.loggedRandom();
    } else {
      this.randomArticle();
    }
    ...
    setTimeout(() => {
      console.log(this.loggedArticles)
    }, "1000")
  ...
  methods: {
    ...
    refreshTok() {
      ...
      myHeaders.append(
        "authorization",
        "Refresh " + this.cookiesObject.refToken
      );
      myHeaders.append(
        "Cookie",
      ...
      fetch(window.API + "/refresh", requestOptions)
        ...
        .then((result) => {
          if (result.token && result.token != "undefined") {
            ...
            document.cookie =
              "refToken = ; expires = Thu, 01 Jan 1970 00:00:00 GMT";
            document.cookie =
              "number = ; expires = Thu, 01 Jan 1970 00:00:00 GMT";
            document.cookie =
    ...
    loggedRandom() {
      ...
      fetch(window.API + "/userInitialContent", requestOptions)
        ...
        .then((result) => {
          ...
          } else this.loggedArticles = result;
        })
        .catch((error) => console.log("error", error));
    },
